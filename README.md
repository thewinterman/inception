...
- A Project description section must also explain the use of Docker and the sources included in the project. It must indicate the main  esign choices, as well as a comparison between:
